...
export const ICON_REGISTRY: Record<IconName, string> = {
  ...
  'leadcars': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-9-9"/><path d="M17 12a5 5 0 1 1-5-5"/><circle cx="12" cy="12" r="1.75" fill="currentColor" stroke="none"/><path d="m12 12 9-9"/><path d="M15 3h6v6"/></svg>`,
