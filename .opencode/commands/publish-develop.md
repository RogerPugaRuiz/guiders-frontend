---
description: Publish changes to develop branch
agent: general
model: github-copilot/claude-haiku-4.5
---

Review the current git status and recent changes, then publish them to the develop branch:
...
- Report the final status and confirm the changes are on develop branch
