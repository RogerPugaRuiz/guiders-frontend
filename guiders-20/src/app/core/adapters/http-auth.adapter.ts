...
export class HttpAuthAdapter implements AuthRepositoryPort {
  ...
  async getSession(): Promise<AuthSession | null> {
    try {
      ...
      if (!sessionData) {
        // En lugar de console.warn, usar console.debug para ser menos ruidoso
        // Solo mostrar warning si esperábamos encontrar una sesión
        console.debug('No session data found in storage');
        return null;
      }
